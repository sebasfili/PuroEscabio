        ...
        <div class="container">
            ...
            <div class="login-form-grids">
                ...
                <form action="#" method="post">
                    <input type="text" placeholder="Nombre" required class="form-control form-control-lg">
                    <input type="text" placeholder="Apellido" required class="form-control form-control-lg">
                </form>
                ...
                <form action="#" method="post">
                    ...
                    <input type="password" placeholder="Confirmación de Contraseña" class="form-control form-control-lg">
